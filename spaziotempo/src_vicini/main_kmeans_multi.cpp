...
int main() {
  ...
  fs::create_directories(output_dir+"/2d_st_kmulti/vicini");
...
//std::cout<<"crea file mem centr"<<std::endl;
      std::string out_memb_file = output_dir + "2d_st_kmulti/" + curve_types[0] + "/memberships"+ "_" + std::to_string(n) + ".csv";
      std::string out_cent_file = output_dir + "2d_st_kmulti/" + curve_types[0] + "/centroids"+ "_" + std::to_string(n) + ".csv";
